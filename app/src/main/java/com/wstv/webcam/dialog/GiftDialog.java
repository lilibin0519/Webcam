        ...
        findViewById(R.id.dialog_gift_list_send).setOnClickListener(new ClickProxy(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != sendListener) {
                    ...
                    sendListener.onSendGift(count.getText().toString(), data.get(((CamDetailActivity) context).giftSelectPosition));
                }
            }
        }));
        findViewById(R.id.dialog_gift_list_send).setVisibility(((CamDetailActivity) context).giftSelectPosition == -1 ? View.INVISIBLE : View.VISIBLE);
...
//                plus.setVisibility(!"0".equals(data.get(((CamDetailActivity) context).giftSelectPosition).ifMoreThanOnce) && !TextUtils.isEmpty(data.get(((CamDetailActivity) context).giftSelectPosition).fiveTimesUrl) ? View.VISIBLE : View.INVISIBLE);
            ...
            public void onLongClick(int position, GiftBean giftBean, View itemView) {
                ...
                ((CamDetailActivity) context).showGiftPop(/*itemView.getX()*/location[0] + itemView.getWidth() / 2, location[1],/*itemView.getY()*/giftBean.giftComboDTOS);
            }
        })));
    }
