...
public class LoginPhoneActivity extends BaseActivity implements View.OnClickListener, CountDownTimerListener {
    ...
    @Bind(R.id.activity_login_phone_send)
    Button send;
...
//        setRightTextStr(getString(R.string.title_register));
        setLeftTextStr(getString(R.string.back_login));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.activity_login_phone_submit:
                toLogin();
                break;
            case R.id.activity_login_phone_send:
                sendSMS();
                break;
        }
    }
...
//            @Override
//            public void onSuccess(EmptyResult emptyResult, int id) {
//                HttpService.loginOrRegister(LoginPhoneActivity.this, phoneNumber.getText().toString(), new LoginCallback(LoginPhoneActivity.this));
//            }
//        });
        HttpService.loginOrRegister(LoginPhoneActivity.this, phoneNumber.getText().toString(), new LoginCallback(LoginPhoneActivity.this));
    }
