...
public class GiftHolder extends CustomHolder<GiftBean> {
    ...
    public void initView(final int position, final List<GiftBean> datas, Context context) {
        ...
        holderHelper.setBackgroundRes(R.id.item_gift_list_bg, ((CamDetailActivity) context).getGiftSelectPosition() == position ? R.drawable.bg_gift_selected : R.drawable.bg_gift_not_select);
