package com.wstv.webcam.tencent.roomutil.http;
...
public class HttpRequests {
    ...
    public void login(long sdkAppID, String userID, String userSig, String platform, final OnResponseCallback<HttpResponse.LoginResponse> callback) {
        login(domain, sdkAppID, userID, userSig, platform, callback);
    }

    public void login(String main, long sdkAppID, String userID, String userSig, String platform, final OnResponseCallback<HttpResponse.LoginResponse> callback) {
        try {
            String body = "";
            Request request = new Request.Builder().url(main.concat("/login").concat(String.format("?sdkAppID=%s&userID=%s&userSig=%s&platform=%s", String.valueOf(sdkAppID), userID, userSig, platform)))
                    .post(RequestBody.create(MEDIA_JSON, body))
                    .build();
