...
final public class DaoConfig {
    ...
    private NiceDB.DbUpdateListener dbUpdateListener;
     ...
     * @return
     */
    public NiceDB.DbUpdateListener getDbUpdateListener() {
     ...
     * 数据库升级时监听器
     */
    public void setDbUpdateListener(NiceDB.DbUpdateListener dbUpdateListener) {
