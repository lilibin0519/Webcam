package com.libin.mylibrary.widget.swiperecyclerview.footerView;
...
public class SimpleFooterView extends BaseFooterView{
    ...
    public SimpleFooterView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.layout_swipe_footer_view, this);
