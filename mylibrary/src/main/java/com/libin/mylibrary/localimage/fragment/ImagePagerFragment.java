...
public class ImagePagerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                title.setText((getCurrentItem() + 1) + "/" + paths.size());
            }
    ...
    private void initTitle(View rootView) {
        ...
        title.setText((getCurrentItem() + 1) + "/" + paths.size());
        rootView.findViewById(R.id.title_bar_left).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().onBackPressed();
            }
        });
//        rootView.findViewById(R.id.layoutMenu).setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent photoEdit = new Intent(getContext(), PhotoEditActivity.class);
//                Bundle bundle = new Bundle();
//                bundle.putString(PhotoEditActivity.KEY_PHOTO_PATH, paths.get(mViewPager.getCurrentItem()));
//                photoEdit.putExtras(bundle);
//                startActivityForResult(photoEdit, PhotoEditActivity.EDIT_REQUEST_CODE);
//            }
//        });
    }
    ...
    public void setParent(PhotoPickerFragment photoPickerFragment) {
