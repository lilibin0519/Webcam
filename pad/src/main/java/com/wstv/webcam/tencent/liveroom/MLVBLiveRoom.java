...
public abstract class MLVBLiveRoom {
     ...
     *
     */
    public abstract void enterRoom(final String roomID, final TXCloudVideoView view, final IMLVBLiveRoomListener.EnterRoomCallback callback, final String gender, final int level);
    ...
    public abstract List<AnchorInfo> getCurrentRoomPushers();
}
