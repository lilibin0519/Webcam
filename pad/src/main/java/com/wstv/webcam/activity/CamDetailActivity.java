...
//                addMyText(getApp().getUserBean().userName, msg);
                ...
                liveRoom.sendRoomCustomMsg("wsMessage", GsonUtils.gsonString(CamDetailActivity.this.msg), new IMLVBLiveRoomListener.SendRoomCustomMsgCallback() {
                    @Override
                    public void onError(int errCode, String errInfo) {
...
//        }
    ...
    private void requestJoinPusher(){
        ...
        liveRoom.requestJoinAnchor(performerId, new IMLVBLiveRoomListener.RequestJoinAnchorCallback(){
            @Override
