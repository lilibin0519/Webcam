...
import com.wstv.webcam.adapter.LivePagerAdapter;
import com.wstv.webcam.dialog.OrderCodeDialog;
...
import com.wstv.webcam.widget.DifferentDisplay;
import com.wstv.webcam.widget.GiftPopWindow;
import com.wstv.webcam.widget.GiftTablePop;
import com.wstv.webcam.widget.NoScrollViewPager;
...
//                }
    ...
    private void audienceState(final RoomInfo room) {
...
//                    liveRoom.removeCurrentRoom();
    ...
    public void enterRoom2(TXCloudVideoView videoView){
        liveRoom.enterRoom(roomId, videoView, new IMLVBLiveRoomListener.EnterRoomCallback() {
            @Override
...
//                }
    ...
    private void sendUserAdd(){
        ...
        liveRoom.sendRoomCustomMsg("wsUser", /*"{\"type\":\"gift\", \"no\":\"100\"}"*/GsonUtils.gsonString(msg), new IMLVBLiveRoomListener.SendRoomCustomMsgCallback() {
            @Override
            public void onError(int errCode, String errInfo) {
...
//        giftDialog.setAccount(getApp().getUserBean().coins);
        ...
        liveRoom.sendRoomCustomMsg("wsGift", /*"{\"type\":\"gift\", \"no\":\"100\"}"*/GsonUtils.gsonString(msg), new IMLVBLiveRoomListener.SendRoomCustomMsgCallback() {
            @Override
            public void onError(int errCode, String errInfo) {
...
//                addMyText(getApp().getUserBean().userName, msg);
                ...
                liveRoom.sendRoomCustomMsg("wsMessage", GsonUtils.gsonString(LivePageActivity.this.msg), new IMLVBLiveRoomListener.SendRoomCustomMsgCallback() {
                    @Override
                    public void onError(int errCode, String errInfo) {
    ...
    private void requestRoomType() {// TODO
