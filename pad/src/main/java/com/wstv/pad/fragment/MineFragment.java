...
import com.wstv.pad.activity.AboutUsActivity;
import com.wstv.pad.activity.BindPhoneActivity;
import com.wstv.pad.activity.CashActivity;
import com.wstv.pad.activity.StartActivity;
import com.wstv.pad.activity.UserInfoActivity;
...
//        Glide.with(getContext()).load(userBean.headPortrait).into(avatar);
        GlideLoadUtils.getInstance().glideLoad(getContext(), userBean.headPortrait,
                avatar);
